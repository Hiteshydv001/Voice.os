...
import { Terminal, Lock, AlertTriangle, ArrowRight, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-stone-100 flex items-center justify-center p-4 font-mono">
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-8">
            <div className="w-16 h-16 bg-black flex items-center justify-center border-4 border-black shadow-[8px_8px_0px_0px_rgba(234,88,12,1)]">
        ...
        <div className="bg-white border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-8">
          <div className="border-b-4 border-black pb-4 mb-6 text-center">
            ...
            <p className="text-xs font-bold text-stone-500 mt-1 uppercase">Secure Gateway v2.0</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-xs font-bold uppercase mb-2">Personnel ID (Email)</label>
              <input
                type="email"
                required
            ...
            <div>
              <label className="block text-xs font-bold uppercase mb-2">Access Key (Password)</label>
              <input
                type="password"
                required
                className="w-full px-4 py-3 bg-stone-50 border-2 border-black focus:outline-none focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-shadow font-medium"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-black text-white border-2 border-black font-bold uppercase hover:bg-orange-600 transition-colors shadow-[4px_4px_0px_0px_rgba(100,100,100,1)] active:shadow-none active:translate-x-[2px] active:translate-y-[2px]"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase font-bold">
              <span className="bg-white px-2 text-stone-500">Or Access Via</span>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t-2 border-black text-center text-xs font-bold uppercase">
            <p className="mb-2">No Clearance?</p>
            <Link to="/signup" className="inline-flex items-center text-orange-600 hover:bg-orange-100 px-2 py-1 transition-colors">
